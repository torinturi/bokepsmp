...
A live demo of the project is available at [https://bokepparty.pages.dev](https://bokepparty.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep party`)
...
1. Fork the [repository](https://torinturi/bokepparty/fork) on GitHub.
