...
A live demo of the project is available at [https://bokepsmp.pages.dev](https://bokepsmp.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep smp`)
...
1. Fork the [repository](https://torinturi/bokepsmp/fork) on GitHub.
